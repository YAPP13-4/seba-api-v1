...
module.exports = {
  relationInit: () => {
    ...
    Music.hasMany(Featured, { foreignKey: 'music_id', sourceKey: 'id' });
    Featured.belongsTo(Music, { foreignKey: 'music_id', targetKey: 'id' });

    Music.hasMany(Comment, { foreignKey: 'music_id', sourceKey: 'id' });
    Comment.belongsTo(Music, { foreignKey: 'music_id', targetKey: 'id' });
  },
      ...
      [
        {
          ...
          musicianImg: 'https://i1.sndcdn.com/avatars-000547422291-584oku-large.jpg',
          description:
            '구름이 예쁘다\n\n\n사실 너가\n\n예쁜건데  \n\n\n바람이 포옹같구나\n\n\n사실 너가 \n\n안고싶은건데 \n\n\n\n배가 자꾸 허전해\n\n\n사실 너가 \n\n보고싶은건데\n\n\n\n아 이제는 익숙해\n\n\n사실 너가\n\n있어야 괜찮을텐데 \n\n\n\n\n이제야 뭐가 중요한지 잘 알아 \n\n모든걸 쏟아야할게 무엇이었는지 말야\n\n의미가 없어진 갇혀진 시간 안\n\n장면을 되풀이하며 흐르는걸 닦아',
        ...
        },
        {
          ...
          musician: 'Scentok (쎈톡)',
          musicianImg: 'https://i1.sndcdn.com/avatars-000521203020-ex9f0k-large.jpg',
          description:
          ...
          artworkImg: 'https://i1.sndcdn.com/artworks-000406292886-wpouvc-large.jpg',
          duration: 215111,
        ...
        },
        {
          ...
          musicianImg: 'https://i1.sndcdn.com/avatars-000494686350-mc3f1i-large.jpg',
          description:
          ...
          artworkImg: 'https://i1.sndcdn.com/artworks-000394444782-qmy3sr-large.jpg',
          duration: 221172,
